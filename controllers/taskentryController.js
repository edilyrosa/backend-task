...
export const getTaskentryById = async (req, res) => {
 ...
 export const createTaskentry = async (req, res) => {
  const { contractor_id, date, duration, billable, project_id, product_id, category_id, description } = req.body;

  try {
    const insertQuery = `
      INSERT INTO taskentry (contractor_id, date, duration, billable, project_id, product_id, category_id, description)
      VALUES ($1, $2, $3, $4, $5, $6, $7, $8)
      RETURNING *`;
      
    const insertValues = [contractor_id, date, duration, billable, project_id, product_id, category_id, description];
...
export const updateTaskentry = async (req, res) => {
  ...
  try {
    const updateQuery = `
      UPDATE taskentry
      SET contractor_id = $1, date = $2, duration = $3, billable = $4, project_id = $5, product_id = $6, category_id = $7, description = $8
      WHERE id = $9
      RETURNING *`;

    const updateValues = [contractor_id, date, duration, billable, project_id, product_id, category_id, description, taskentryId];
